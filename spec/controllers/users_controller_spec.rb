...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should show the number of microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "Baz quux")
      get :show, :id => @user
      response.should have_selector("span#nummicroposts", :content => '2')
    end
    ...
    describe "microposts delete links" do
      before(:each) do
        @user2 = Factory(:user, :name => 'user2', :email => 'prueba@prueba.com')
        Factory(:micropost, :user => @user2)
        test_sign_in(@user)
      end
    ...
    describe "following/followers stats" do
      ...
      it "should show the right following/followers count" do
        get :show, :id => @user
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "José María Silla", :email => "josilma1@gmail.com", :password => "prueba123", 
